...
window.addEventListener("keydown", function(e) {
    ...
    const style = "{height: 95px; width: 95px; margin: 12.5px;}";

    if (e.key === 'Q' || e.key === 'q') {
        bell1();
        const x = document.createElement("STYLE");
        const t = document.createTextNode("#a" + style);
        x.appendChild(t);
    ...
    if (e.key === 'W' || e.key === 'w') {
        bell2();
        const x = document.createElement("STYLE");
        const t = document.createTextNode("#b" + style);
        x.appendChild(t);
        document.head.appendChild(x);
    }
    if (e.key === 'E' || e.key === 'e') {
        bell3();
        const x = document.createElement("STYLE");
        const t = document.createTextNode("#c" + style);
        x.appendChild(t);
        document.head.appendChild(x);
    }
    if (e.key === 'A' || e.key === 'a') {
        bell4();
        const x = document.createElement("STYLE");
        const t = document.createTextNode("#d" + style);
        x.appendChild(t);
        document.head.appendChild(x);
    }
    if (e.key === 'S' || e.key === 's') {
        bell5();
        const x = document.createElement("STYLE");
        const t = document.createTextNode("#e" + style);
        x.appendChild(t);
        document.head.appendChild(x);
    }
    if (e.key === 'D' || e.key === 'd') {
        bell6();
        const x = document.createElement("STYLE");
        const t = document.createTextNode("#f" + style);
        x.appendChild(t);
        document.head.appendChild(x);
    }
    if (e.key === 'Z' || e.key === 'z') {
        bell7();
        const x = document.createElement("STYLE");
        const t = document.createTextNode("#g" + style);
        x.appendChild(t);
        document.head.appendChild(x);
    }
    if (e.key === 'X' || e.key === 'x') {
        bell8();
        const x = document.createElement("STYLE");
        const t = document.createTextNode("#h" + style);
        x.appendChild(t);
        document.head.appendChild(x);
    }
    if (e.key === 'C' || e.key === 'c') {
        bell9();
        const x = document.createElement("STYLE");
        const t = document.createTextNode("#i" + style);
        x.appendChild(t);
        document.head.appendChild(x);
    }
});
